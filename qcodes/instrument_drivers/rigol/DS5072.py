...
class RigolDS5072Channel(InstrumentChannel):
...
class DS5072(VisaInstrument):
    ...
    def __init__(self, name, address, timeout=20, **kwargs):
        ...
        channels = ChannelList(self, "Channels", RigolDS5072Channel, snapshotable=False)
    ...
    def _check_firmware_version(self):
        #Require version 00.01.12
        # We cant update the firware, USB port is dead
